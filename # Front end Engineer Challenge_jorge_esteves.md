...
The last project I worked on was a logistics platform data driven web application written in VueJs.


## 2. General

##### 2.1. What kind of front end projects do you enjoy working on? Why?
I enjoy working on projects design oriented and that fullfill a cliente need. Helping the end user is my main goal,
if He can resolve his problem faster and better then my job is done well.

##### 2.2. Which are your favorite features of HTML5? How have you used them before?
<Figure> <Section> are my two favorite features to use when writting code, I would love to try out Inbuilt Geo-location in the future.

##### 2.3. Explain the difference between creating a DOM element setting `innerHTML` and using `createElement`.
Creating a DOM element using innerHTML is cleaner, especially when we start adding in extra properties like classes and javascript events.
Otherwise with createElement we must append on each iteration, resulting in a recalculation of styles, painting and layout every single time.

##### 2.4. Compare two-way data binding vs one-way data flow.
Two way data binding keeps updating its content using model and one source of truth, while one way data flow 

##### 2.5. Why is asynchronous programming important in JavaScript?
So we can continue executing the script while the code awaits for the end result, otherwise would block until finished the logic/call.
